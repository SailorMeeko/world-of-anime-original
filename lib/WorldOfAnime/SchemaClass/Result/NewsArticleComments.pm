package WorldOfAnime::SchemaClass::Result::NewsArticleComments;
...
__PACKAGE__->table("news_article_comments");
...
__PACKAGE__->belongs_to(
  "news_article",
  "WorldOfAnime::SchemaClass::Result::NewsArticles",
  { "foreign.id" => "self.news_article_id" },
);
__PACKAGE__->belongs_to(
  "news_commentor",
