package WorldOfAnime::SchemaClass::Result::UserFavoriteMovies;
...
__PACKAGE__->table("user_favorite_movies");
...
__PACKAGE__->belongs_to(
  "favorite_to_movie_title",
  "WorldOfAnime::SchemaClass::Result::MovieTitles",
  { id => "movie_title_id" },
);
